...
public class TripDriverBlock extends LinearLayout {
	...
	protected void initItems() {
		...
		mPhone = (ImageView) findViewById(R.id.trip_driver_block_phone);
		mText = (ImageView) findViewById(R.id.trip_driver_block_text);
		mEMail = (ImageView) findViewById(R.id.trip_driver_block_email);
		mRating = (RatingBar) findViewById(R.id.trip_driver_block_rating);
		mFeedback = (Button) findViewById(R.id.trip_driver_block_feedback);
	}
